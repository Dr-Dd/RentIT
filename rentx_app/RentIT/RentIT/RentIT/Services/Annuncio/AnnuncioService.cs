...
namespace App.Services.Annuncio
{
    public class AnnuncioService : IAnnuncioService
    {
        ...
        public async Task<Response> Delete(string idAd)
        {
        ...
        public async Task<Response> ModifyItemData(Ad a)
        {
        ...
        {   
            //sempre stessa storia dobbiamo(Mauro) prima decidere come salvare le immagini , poi posso farlo 
