...
namespace RentIT
{
    public static class Constants
    {
        ...
        // URL of REST service
        public static string RestUrl = "http://10.25.76.52:8080/{0}";

        // defaul Endpoints for api
        const string defaultAuthenticationEndpoint = "http://10.25.76.52:8080/auth/{0}";
        const string defaultItemEndpoint = "http://10.25.76.52:8080/item/{0}";
        const string defaultProductEndpoint = "http://10.25.76.52:8080/product/{0}";
        const string defaultUserEndpoint = "http://10.25.76.52:8080/utente/{0}";
