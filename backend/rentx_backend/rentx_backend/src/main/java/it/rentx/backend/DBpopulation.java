...
public class DBpopulation implements ApplicationRunner {
	...
	private void addAll() {
        ...
        Annuncio a1 = new Annuncio("Tosaerba", "Tosaerba BOSCHIA potente, alimentato a escermenti di piccione", null, null, 13, u1, u1.getAddress(), new Date());
        Annuncio a2 = new Annuncio("Motosega", "Motosega a benzina, perfetta per le potature", null, null, 8, u1, u1.getAddress(), new Date());
        Annuncio a3 = new Annuncio("Frac", "Noleggio frac, ovvero giacca, pantalone, gilet bianco, papillon bianco e camicia. Nel prezzo è incluso il servizio lavanderia", null, null, 200, u2, u2.getAddress(), new Date());
        Annuncio a4 = new Annuncio("Proiettore", "Videoproiettore con risoluzione altissimissima. Non consuma nemmeno troppo", null, null, 20, u3, u3.getAddress(), new Date());
        Annuncio a5 = new Annuncio("Fotocamera", "Fotocamera professionale super costosa, noleggiabili anche diversi obiettivi", null, null, 40, u3, u3.getAddress(), new Date());
        Annuncio a6 = new Annuncio("Schermo per proiettore", "Schermo 80 Pollici. Supporto Pieghevole", null, null, 10, u3, u3.getAddress(), new Date());
        Annuncio a7 = new Annuncio("Planetaria", "Planetaria per fare i dolci buoni buoni", null, null, 13, u4, u4.getAddress(), new Date());
        Annuncio a8 = new Annuncio("Affettatrice", "Affettatrice elettrica professionale in acciaio inossidabile, spessore max 15 mm, potenza 150 W", null, null, 10, u4, u4.getAddress(), new Date());
